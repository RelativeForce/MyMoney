...
import { BudgetSeries } from 'mymoney-common/lib/classes';
import { ISeriesItem, ISeries } from 'mymoney-common/lib/interfaces';
...
import { randomColor } from 'mymoney-common/lib/functions';
