...
export const selectTransactions = (state: IAppState): ITransactionModel[] =>
   selectTransactionState(state).transactions;
...
): (state: IAppState) => ITransactionModel | undefined {
   return (state: IAppState): ITransactionModel | undefined =>
